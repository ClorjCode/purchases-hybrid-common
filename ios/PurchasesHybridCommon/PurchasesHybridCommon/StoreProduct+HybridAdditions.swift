...
internal extension StoreProduct {
    ...
    static func rc_normalized(subscriptionPeriod: StoreKit.Product.SubscriptionPeriod) -> String {
    ...
    static func rc_normalized(subscriptionPeriodUnit: StoreKit.Product.SubscriptionPeriod.Unit) -> String {
